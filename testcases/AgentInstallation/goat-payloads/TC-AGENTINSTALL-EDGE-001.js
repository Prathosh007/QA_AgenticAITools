...
testcaseId = "TC-AGENTINSTALL-EDGE-001";
payload = {
  "testcase_id": "TC-AGENTINSTALL-EDGE-001",
  "description": "Install agent when install directory already exists with stale files",
  ...
  "operations": [
    {
      ...
      "parameters": {
        ...
        "description": "Pre-check: stale directory exists"
      }
    },
    {
      ...
      "parameters": {
        ...
        "args": "/silent",
        "timeout": 120,
        "description": "Install over stale directory"
      }
    },
    {
    ...
    },
    {
      ...
      "parameters": {
        ...
        "key_name": "ServerName",
        "description": "Verify registry correct"
      }
    }
  ],
  "expected_result": "Installer handles stale directory gracefully. Agent installs. Service RUNNING."
};

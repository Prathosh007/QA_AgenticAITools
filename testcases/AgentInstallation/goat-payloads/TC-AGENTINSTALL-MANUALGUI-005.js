...
testcaseId = "TC-AGENTINSTALL-MANUALGUI-005";
payload = {
  "testcase_id": "TC-AGENTINSTALL-MANUALGUI-005",
  "description": "Manual GUI install on Windows 11",
  ...
  "operations": [
    {
      ...
      "parameters": {
        ...
        "timeout": 10,
        "description": "Launch agent installer on Windows 11"
      }
    },
    {
    ...
    },
    {
      ...
      "parameters": {
        ...
        "description": "Verify agent service RUNNING on Win11"
      }
    },
    {
      ...
      "parameters": {
        ...
        "key_name": "ServerName",
        "description": "Verify ServerName registry key"
      }
    },
    {
  ...
  "expected_result": "Installation completes on Windows 11. Agent service RUNNING. Registry keys populated. Install directory exists."
};

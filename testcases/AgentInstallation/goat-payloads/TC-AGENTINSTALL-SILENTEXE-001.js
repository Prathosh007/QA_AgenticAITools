...
testcaseId = "TC-AGENTINSTALL-SILENTEXE-001";
payload = {
  "testcase_id": "TC-AGENTINSTALL-SILENTEXE-001",
  "description": "Fresh silent installation using EXE /silent flag",
  ...
  "operations": [
    {
      ...
      "parameters": {
        ...
        "args": "/silent",
        "timeout": 120,
        "description": "Run silent EXE install"
      }
    },
    {
    ...
    },
    {
      ...
      "parameters": {
        ...
        "key_name": "ServerName",
        "description": "Verify ServerName registry key populated"
      }
    },
    {
  ...
  "expected_result": "No GUI appears. Agent installs silently. Service RUNNING. Registry keys populated. Install directories exist."
};
